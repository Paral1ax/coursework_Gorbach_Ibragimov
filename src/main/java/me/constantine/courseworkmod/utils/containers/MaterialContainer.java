...
public class MaterialContainer {
    ...
    private void getHouse1BlockCounter(Location min, Location max){
    ...
    private void getHouse2BlockCounter(Location min,Location max){
    ...
    private void getFarmBlockCounter(Location min, Location max){
